...
public partial class KH2FM {
    ...
    public class SoraSpeed : BaseEffect
    {
        ...
        public override IList<String> Codes { get; } = new [] { EffectIds.Hastega, EffectIds.Slowga };

        public override IList<String> Mutexes { get; } = new [] { EffectIds.Hastega, EffectIds.Slowga };
